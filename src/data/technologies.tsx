...
const technologies = {
  ...
  CSharp: {
    icon: <TbBrandCSharp aria-label="CSharp" />,
    link: "https://learn.microsoft.com/en-us/dotnet/csharp/tour-of-csharp/",
    isCore: false,
  },
  Premiere: {
    icon: <TbBrandAdobePremier aria-label="Premiere" />,
  ...
  string,
  { icon?: JSX.Element | undefined; link: string; isCore?: boolean }
>;
